...
import com.edupeep.eduapis.utils.MailUtils;
import com.edupeep.eduapis.utils.PasswordGenerator;
...
public class EmployeeServices {
	...
	public Employee createEmployee( Employee employee) {
		...
		PasswordGenerator passwordGenerator = new PasswordGenerator.PasswordGeneratorBuilder()
		        ...
		        .useUpper(true)
		        .build();
		String activeLink = passwordGenerator.generate(16); 
		
		employee.setActiveLink(activeLink);
		
		Employee emp = employeeRepository.save(employee);
		
		try {
			sendUserRegMail(employee);
	...
	private void sendUserRegMail(Employee employee) throws MessagingException {
